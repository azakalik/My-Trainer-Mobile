...
fun AuthNavigatorHandler(
    ...
    NavHost(
        ...
        composable(AuthNavigatorItems.SignIn.route) { ShowSignInScreen(onNavigateToSignUp = {navController.navigate(AuthNavigatorItems.SignUp.route){
            popUpTo(AuthNavigatorItems.SignUp.route){inclusive = false}
        } }, onNavigateToAppNavigator) }
        composable(AuthNavigatorItems.SignUp.route) { ShowSignupScreen(onNavigateToSignIn = {navController.navigate(AuthNavigatorItems.SignIn.route){
